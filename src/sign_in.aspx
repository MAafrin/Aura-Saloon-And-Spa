<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sign_in.aspx.cs" Inherits="AuraBeautyAndCare.sign_in" %>
...
<body>
    ...
    <div class="jumbotron jumbotron-fluid bg-jumbotron" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h3 class="text-white display-3 mb-4">Sign In</h3>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row mx-0 justify-content-center text-center">
                <div class="col-lg-6">
                    <h6 class="d-inline-block bg-light text-primary text-uppercase py-1 px-2">Sign In</h6>
            ...
            <div class="row justify-content-center bg-appointment mx-0">
                <div class="col-lg-6 py-5">
                    <div class="p-5 my-5" style="background: rgba(33, 30, 28, 0.7);">
                        ...
                        <form action="sign_in.aspx" method="post" runat="server">
                            <div class="form-row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        
                                        <asp:TextBox ID="txt_email" runat="server" placeholder="Your Email" required="required" class="form-control bg-transparent p-4"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <asp:Button ID="btn_signin" runat="server" Text="Sign In" class="btn btn-primary btn-block" style="height: 47px;" OnClick="btn_signin_Click"  />
                                </div>
                            </div>
                        </form>
                    </div>
