<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sign_up.aspx.cs" Inherits="AuraBeautyAndCare.sign_up" %>
...
<body>
    ...
    <div class="jumbotron jumbotron-fluid bg-jumbotron" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h3 class="text-white display-3 mb-4">Sign Up</h3>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row mx-0 justify-content-center text-center">
                <div class="col-lg-6">
                    <h6 class="d-inline-block bg-light text-primary text-uppercase py-1 px-2">Sign Up</h6>
                    <h1 class="mb-5">Register Your Details</h1>
                </div>
            </div>
            <div class="row justify-content-center bg-appointment mx-0">
                <div class="col-lg-6 py-5">
                    <div class="p-5 my-5" style="background: rgba(33, 30, 28, 0.7);">
                        <h1 class="text-white text-center mb-4">Get Started</h1>
                        <form action="sign_up.aspx" method="post" runat="server">
                            <div class="form-row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        
                                        <asp:TextBox ID="txt_name" runat="server" class="form-control bg-transparent p-4" placeholder="Your Name" required="required"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                
                                        <asp:TextBox ID="txt_email" runat="server" class="form-control bg-transparent p-4" placeholder="Your Email" required="required"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txt_password" runat="server" class="form-control bg-transparent p-4" placeholder="Your Password" required="required"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                   
                                        <asp:TextBox ID="txt_contact" runat="server"  class="form-control bg-transparent p-4" placeholder="Your Contact" required="required"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddl_gender" runat="server" class="custom-select bg-transparent px-4" style="height: 47px;" placeholder="Your Gender" required="required" >
                                             <asp:ListItem Selected>Select A Gender</asp:ListItem>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <asp:Button ID="btn_sign_up" runat="server" Text="Sign Up" class="btn btn-primary btn-block" type="submit" style="height: 47px;" OnClick="btn_sign_up_Click" />
                                </div>
                            </div>
                        </form>
                    </div>
